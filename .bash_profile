...
# Purge ssh-agent and re-add own private key if available
ssh-add -q -D
[[ -s "$HOME/.ssh/nhoffmann" ]] && ssh-add -q "$HOME/.ssh/nhoffmann"

# Checks for iTerm2 Shell integration and uses it if available
